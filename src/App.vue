        ...
        <div class="space-y-2">
          <div class="bg-gray-300 rounded-sm">
            <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
              ...
              <div class="w-full">
                <input type="text" placeholder="Digite a sua tarefa" value="Estudar Vue 3" class="bg-gray-300 placeholder-gray-500 text-gray-700 font-light focus:outline-none block w-full appearance-none leading-normal mr-3">
              </div>
          ...
          <div class="bg-gray-300 rounded-sm">
            <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
              ...
              <div class="w-full">
                <input type="text" placeholder="Digite a sua tarefa" value="Estudar Vue 3" readonly class="line-through bg-gray-300 placeholder-gray-500 text-gray-700 font-light focus:outline-none block w-full appearance-none leading-normal mr-3">
              </div>
